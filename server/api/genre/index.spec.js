...
var genreCtrlStub = {
  ...
  upsert: 'genreCtrl.upsert',
  patch: 'genreCtrl.patch',
...
describe('Genre API Router:', function() {
  ...
  describe('PUT /api/genres/:id', function() {
    it('should route to genre.controller.upsert', function() {
      expect(routerStub.put
        .withArgs('/:id', 'genreCtrl.upsert')
        ).to.have.been.calledOnce;
    });
  });

  describe('PATCH /api/genres/:id', function() {
    it('should route to genre.controller.patch', function() {
      expect(routerStub.patch
        .withArgs('/:id', 'genreCtrl.patch')
        ).to.have.been.calledOnce;
    });
  });
